...
function Model(data) {
	...
	if(!this.constructor.collection && this.constructor.connection) {
		...
		this.__proto__.save = this.constructor.connection.save;
		this.__proto__.refresh = this.constructor.connection.refresh;
		this.__proto__.del = this.constructor.connection.del;
	}
