...
util.inherits(Object, events.EventEmitter);
...
Object.prototype.define = function(key, type) {
...
Object.prototype.toJSON = function() {
	...
	for(var key in this._data) {
		if(this._data[key] instanceof Object) {
			n[key] = this._data[key].toJSON();
		} else if(this._data[key] instanceof Array && this._type[key][0].prototype instanceof Object) {
